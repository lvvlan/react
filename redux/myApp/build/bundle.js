...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dbt = __webpack_require__(66);

	var _dbt2 = _interopRequireDefault(_dbt);

	var _xbw = __webpack_require__(75);

	var _xbw2 = _interopRequireDefault(_xbw);

	var _bn = __webpack_require__(80);
	...
	RD.render(React.createElement(
	    ...
	    { store: store },
	    React.createElement(_dbt2.default, null)
	), document.getElementById('dbt'));

	RD.render(React.createElement(
	    _reactRedux.Provider,
	    { store: store },
	    React.createElement(_xbw2.default, null)
	), document.getElementById('xbw'));

	RD.render(React.createElement(
	    _reactRedux.Provider,
	    { store: store },
	    React.createElement(_bn2.default, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _symbolObservable = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createKey = __webpack_require__(59);
	...
	var rootReducer = (0, _redux.combineReducers)({
	    DBT_left: DBT_left,
	    DBT_middle: DBT_middle,
	    DBT_right: DBT_right,
	    DBT_yhj: DBT_yhj,
	    XBW_active: XBW_active,
	    XBW_bh: XBW_bh,
	    XBW_recommend: XBW_recommend,
	    XBW_userInfo: XBW_userInfo,
	    BN_userInfo: BN_userInfo,
	    BN_showList: BN_showList
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _left = __webpack_require__(67);

	var _left2 = _interopRequireDefault(_left);

	var _middle = __webpack_require__(71);

	var _middle2 = _interopRequireDefault(_middle);

	var _right = __webpack_require__(72);

	var _right2 = _interopRequireDefault(_right);

	var _yhj = __webpack_require__(73);

	var _yhj2 = _interopRequireDefault(_yhj);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Dbt = React.createClass({
	    displayName: 'Dbt',
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'yhj', 'data-type': 'dbt-yhj' },
	                    React.createElement(_yhj2.default, null)
	                )
	            ),
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'left clearfix', 'data-type': 'leftProduct' },
	                    React.createElement(_left2.default, null)
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'between clearfix', 'data-type': 'dbtBetween' },
	                    React.createElement(_middle2.default, null)
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'right clearfix', 'data-type': 'rightList' },
	                    React.createElement(_right2.default, null)
	                )
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'left_top', 'data-type': 'dbtLeft' },
	                    _react2.default.createElement(
	                        'ul',
	                        { className: 'item_list', 'data-type': 'content' },
	                        data.promote.map(function (res, i) {
	                            return _react2.default.createElement(
	                                'li',
	                                { key: i },
	                                _react2.default.createElement(
	                                    'a',
	                                    { href: res.href, target: '_blank', 'data-clstag': 'jr|keycount|newbthome|dbthdtj' + (i + 1) },
	                                    _react2.default.createElement('img', { src: res.imgSrc })
	                                )
	                            );
	                        })
	                    ),
	                    _react2.default.createElement(
	                        'ol',
	                        { className: 'point', 'data-type': 'bar' },
	                        data.promote.map(function (res, i) {
	                            return _react2.default.createElement('li', { key: i, className: i == 0 ? 'active' : '' });
	                        })
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'ul',
	                        { className: 'item_list' },
	                        data.articleList.map(function (res, i) {
	                            return _react2.default.createElement(
	                                'li',
	                                { key: i, className: i == 0 ? 'first' : '' },
	                                _react2.default.createElement(
	                                    'a',
	                                    { href: '{res.href}', target: '_blank', title: '{res.title}', 'data-clstag': 'jr|keycount|newbthome|dbthdlist' + (i + 1) },
	                                    _react2.default.createElement(
	                                        'em',
	                                        null,
	                                        '[',
	...
	exports.default = (0, _reactRedux.connect)(getData)(Left);
...
/***/ function(module, exports) {
	...
	//加载数据
	var updateData = exports.updateData = function updateData(json, fnCb) {
	    return function (dispatch) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	slider.prototype = {
	    ...
	    bindEvent: function bindEvent() {
	        ...
	        if (self.options.ctrl) {
	            ...
	            (function () {
	                ...
	                left = $("[data-type=left]", self.options.parent);
	    ...
	    hover: function hover() {
	        ...
	        var hoverFn = (0, _debounce2.default)(function () {
	            var args = arguments,
	                $this = args[0];
	            index = $this.index();
	            //console.log("index: "+index+"^^^self.index: "+self.index+"^^^self.lock: "+self.lock);
	    ...
	    * */
	    ...
	    fade: function fade() {
	        ...
	        bar.eq(index).addClass(activeClass).siblings().removeClass(activeClass);
	        children.eq(index).fadeIn(self.options.duration, function () {
	            self.lock = false;
	            if (self.auto) self.autoPlay();
	        }).siblings().fadeOut(self.options.duration);

	        $.isFunction(self.options.callback) && self.options.callback(self);
	    },
	    //运动形式： switchLR
	    switchLR: function switchLR(n) {
	        var self = this,
	            activeClass = self.options.activeClass,
	            index = self.index,
	            children = self.children,
	        ...
	        children.css("zIndex", 2).eq(index).css("zIndex", 3).show().animate({ left: map.d }, self.options.duration, "easeInOutQuint", function () {
	            self.lock = false;
	            self.switchMap.page = index;
	            children.not(":eq(" + index + ")").hide().css({ left: map.l });
	            if (self.auto) self.autoPlay();
	        });
	    },
	    //运动形式： switchTB
	    switchTB: function switchTB(n) {
	        var self = this,
	            activeClass = self.options.activeClass,
	            index = self.index,
	            children = self.children,
	        ...
	        children.css("zIndex", 2).eq(index).css("zIndex", 3).show().animate({ top: map.d }, self.options.duration, "easeInOutQuint", function () {
	            self.switchMap.page = index;
	            children.not(":eq(" + index + ")").hide().css({ top: map.t });
	            self.lock = false;
	            if (self.auto) self.autoPlay();
	        });
...
/***/ function(module, exports, __webpack_require__) {
	                ...
	                _react2.default.createElement(
	                    ...
	                    data.map(function (res, i) {
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: res.href, target: '_blank', className: 'pic', 'data-clstag': 'jr|keycount|newbthome|dbtsku' + (i + 1) },
	                                _react2.default.createElement('img', { className: 'shake', src: res.imgSrc })
	                            ),
	                            _react2.default.createElement(
	                                'a',
	                                { href: res.href, target: '_blank', className: 'title', title: res.title, 'data-clstag': 'jr|keycount|newbthome|dbtsku' + (i + 1) },
	                                _react2.default.createElement(
	                                    'em',
	                                    { className: 'tag' },
	                                    res.tag
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { className: 'buyNow', href: res.href, target: '_blank', 'data-clstag': 'jr|keycount|newbthome|dbtsku' + (i + 1) },
	                                _react2.default.createElement(
	                                    'em',
	                                    null,
	                                    '立即购买'
	...
	exports.default = (0, _reactRedux.connect)(getData)(Middle);
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                data.map(function (res, i) {
	                    return _react2.default.createElement(
	                        'div',
	                        { key: i, className: i == data.length - 1 ? 'right_item last' : 'right_item' },
	                        _react2.default.createElement(
	                            'a',
	                            { href: '{res.href}', target: '_blank', className: 'section_top clearfix', 'data-clstag': 'jr|keycount|newbthome|dbtbcj{i+1}' },
	                            _react2.default.createElement(
	                                'span',
	                                { className: 'pic' },
	                                _react2.default.createElement('img', { className: 'shake', src: res.imgSrc })
	...
	exports.default = (0, _reactRedux.connect)(getData)(Right);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getUserInfo = __webpack_require__(74);
	...
	var Yhj = function (_Component) {
	    _inherits(Yhj, _Component);

	    function Yhj() {
	        _classCallCheck(this, Yhj);

	        return _possibleConstructorReturn(this, (Yhj.__proto__ || Object.getPrototypeOf(Yhj)).apply(this, arguments));
	    }
	    ...
	    _createClass(Yhj, [{
	        ...
	        key: 'renderYhj',
	        value: function renderYhj(list, json, index) {
	            return list.map(function (res, i) {
	                if (res.type == 'ordinary') {
	                    //普通券
	                    return _react2.default.createElement(
	                        'a',
	                        { key: i, className: 'coupons', href: res.href, target: '_blank', 'data-type': 'coupons', 'data-clstag': 'jr|keycount|newbthome|dbtquan' + (i + 1) },
	                        _react2.default.createElement(
	                            'i',
	                            { className: 'size36' },
	                            '￥'
	                    ...
	                    return _react2.default.createElement(
	                        'a',
	                        { key: i, className: 'coupons free', href: res.href, target: '_blank', 'data-type': 'coupons', 'data-clstag': 'jr|keycount|newbthome|dbtquan' + (i + 1) },
	                        _react2.default.createElement(
	                            'strong',
	                            null,
	                            res.amounts
	                    ...
	                    return _react2.default.createElement(
	                        'a',
	                        { key: i, className: 'coupons discount', href: res.href, target: '_blank', 'data-type': 'coupons', 'data-clstag': 'jr|keycount|newbthome|dbtquan' + (i + 1) },
	                        _react2.default.createElement(
	                            'strong',
	                            { className: 'size36' },
	                            res.amounts,
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'span',
	                    { className: 'kyq' },
	                    data.surplus > 0 ? _react2.default.createElement(
	                        'span',
	                        null,
	                        '您有',
	                        _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'a',
	                    { className: 'more', href: data.moreHref, target: '_blank', 'data-clstag': 'jr|keycount|newbthome|dbtquanmore' },
	                    'MORE ',
	                    _react2.default.createElement(
	                        'i',
	                        { className: 'gt' },
	...
	exports.default = (0, _reactRedux.connect)(getData)(Yhj);
...
/***/ function(module, exports) {
	...
	getUserInfo.prototype = {
	    ...
	    //登录器里的回调
	    userCallBack: function userCallBack(userInfo) {
	        var self = this,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _active = __webpack_require__(76);

	var _active2 = _interopRequireDefault(_active);

	var _bh = __webpack_require__(77);

	var _bh2 = _interopRequireDefault(_bh);

	var _recommend = __webpack_require__(78);

	var _recommend2 = _interopRequireDefault(_recommend);

	var _userInfo = __webpack_require__(79);
	...
	var Xbw = function (_Component) {
	    _inherits(Xbw, _Component);

	    function Xbw() {
	        _classCallCheck(this, Xbw);

	        return _possibleConstructorReturn(this, (Xbw.__proto__ || Object.getPrototypeOf(Xbw)).apply(this, arguments));
	    }
	    ...
	    _createClass(Xbw, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'sideTitle', 'data-type': 'xbwSideTitle' },
	                    _react2.default.createElement(
	                        'h3',
	                        null,
	                        '小白屋'
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'xbwActive', 'data-type': 'xbwActive' },
	                        _react2.default.createElement(_active2.default, null)
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'bh', 'data-type': 'xbwBh' },
	                        _react2.default.createElement(
	                            'h3',
	                            { className: 'title' },
	                            '白话'
	                        ),
	                        _react2.default.createElement(_bh2.default, null)
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'recommend', 'data-type': 'xbwRecommend' },
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'ul',
	                        { className: 'nav', 'data-type': 'bar' },
	                        data.map(function (res, i) {
	                            return _react2.default.createElement(
	                                'li',
	                                { key: i },
	                                _react2.default.createElement('i', { className: res.status ? 'on' : '' }),
	                                res.title
	                            );
	                        })
	                    ),
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { className: 'details', 'data-type': 'content' },
	                    data.map(function (res, i) {
	                        return _react2.default.createElement(
	                            'li',
	                            { key: i },
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: res.href, target: '_blank', 'data-clstag': 'jr|keycount|newbthome|xbwhd' + (i + 1) },
	                                res.btn
	                            )
	                        );
	                    })
	...
	exports.default = (0, _reactRedux.connect)(getData)(Active);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bh = function (_Component) {
	    _inherits(Bh, _Component);

	    function Bh() {
	        _classCallCheck(this, Bh);

	        return _possibleConstructorReturn(this, (Bh.__proto__ || Object.getPrototypeOf(Bh)).apply(this, arguments));
	    }
	    ...
	    _createClass(Bh, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { className: 'speech', 'data-type': 'content' },
	                    data.map(function (res, i) {
	                        return _react2.default.createElement(
	                            'li',
	                            { key: i },
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: res.titleHref, target: '_blank', className: 'word', 'data-clstag': 'jr|keycount|newbthome|baihua' + (i + 1) },
	                                res.title
	                            )
	                        );
	                    })
	                ...
	                _react2.default.createElement(
	                    'a',
	                    { href: 'http://club.jr.jd.com/theme/circle/5?orderBy=1&pageNo=1', target: '_blank', className: 'more', 'data-clstag': 'jr|keycount|newbthome|baihuamore' },
	                    '更多白话',
	                    _react2.default.createElement(
	                        'i',
	                        { className: 'gt' },
	...
	exports.default = (0, _reactRedux.connect)(getData)(Bh);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(Recommend, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                data.bwList.map(function (res, i) {
	                    return _react2.default.createElement(
	                        'a',
	                        { key: i, href: res.href, title: res.title, target: '_blank', className: i == data.bwList.length - 1 ? 'last' : '', 'data-clstag': 'jr|keycount|newbthome|zhoubian' + (i + 1) },
	                        _react2.default.createElement('img', { src: res.imgSrc }),
	                        _react2.default.createElement(
	                            'h3',
	                            null,
	...
	exports.default = (0, _reactRedux.connect)(getData)(Recommend);
...
/***/ function(module, exports, __webpack_require__) {
	            ...
	            switch (this.state.signed) {
	                case 'on':
	                    ...
	                    if (data.isOpen) {
	                        return _react2.default.createElement(
	                            'div',
	                            { className: 'loggedIn', style: { display: 'block' } },
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'appointment', 'data-type': 'appointment' },
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: 's1 been' },
	                                    '加入白条家族共'
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: data.playBtHref, className: 'activeRule clearfix', target: '_blank', 'data-type': 'sbtRule', 'data-clstag': 'jr|keycount|newbthome||wanzhuan' },
	                                '玩转白条'
	                            ),
	                            _react2.default.createElement(
	                                'a',
	                                { href: data.goBtHref, target: '_blank', className: 'activeRule clearfix last', 'data-clstag': 'jr|keycount|newbthome|xbtqdbt' },
	                                '去打白条'
	                            )
	                        );
	                    } else {
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'span',
	                                null,
	                                _react2.default.createElement('i', { className: 'full clearfix' }),
	                                _react2.default.createElement(
	                                    'em',
	                                    { className: 'm16' },
	                                    '激活白条即可参与粉丝活动'
	                            ...
	                            _react2.default.createElement(
	                                'span',
	                                null,
	                                _react2.default.createElement('i', { className: 'get clearfix' }),
	                                _react2.default.createElement(
	                                    'em',
	                                    { 'data-type': 'elevenPay' },
	                                    '白条创意周边只为你'
	...
	exports.default = (0, _reactRedux.connect)(getData)(UserInfo);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _showList = __webpack_require__(81);
	...
	var bn = function (_Component) {
	    _inherits(bn, _Component);

	    function bn() {
	        _classCallCheck(this, bn);

	        return _possibleConstructorReturn(this, (bn.__proto__ || Object.getPrototypeOf(bn)).apply(this, arguments));
	    }
	    ...
	    _createClass(bn, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'item bn', id: 'bn', 'data-type': 'item' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'item_content clearfix' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'titleBox', 'data-type': 'bnUserInfo' },
	                        _react2.default.createElement(_userInfo2.default, null)
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'commodities', 'data-type': 'commodityList' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loopScroll = __webpack_require__(82);
	...
	var ShowList = function (_Component) {
	    ...
	    _createClass(ShowList, [{
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (nextProps.getState.type !== getState.type && nextProps.getState.uid === getState.uid) {
	                dispatch((0, _index.updateData)({
	                    ...
	                    //中奖名单滚动
	                    var scroll = new _loopScroll2.default({
	        ...
	        key: 'hrefTag',
	        value: function hrefTag(json, i) {
	            if (json.linkUrl) {
	                return _react2.default.createElement(
	                    'a',
	                    { href: json.linkUrl, target: '_blank', className: 'pic', 'data-clstag': 'jr|keycount|newbthome|bainasku{i+1}' },
	                    _react2.default.createElement('img', { className: 'shake', src: json.imgSrc }),
	                    json.wechat ? _react2.default.createElement('i', { className: 'wechat' }) : ''
	                );
	            } else {
	                return _react2.default.createElement(
	                    'a',
	                    { href: 'javascript:void(0)', className: 'pic', 'data-clstag': 'jr|keycount|newbthome|bainasku{i+1}' },
	                    _react2.default.createElement('img', { className: 'shake', src: json.imgSrc }),
	                    json.wechat ? _react2.default.createElement('i', { className: 'wechat' }) : ''
	                );
	            }
	        ...
	        key: 'renderTime',
	        value: function renderTime(arr, i) {
	            var localArr = arr,
	                timeStr = '';
	            ...
	            if (this.state.status == 'init') {
	                ...
	                if (localArr[i].isExpire) {
	                    //已过期
	                    timeStr = '已结束';
	                } else {
	                    if (localArr[i].end - this.state.curTime <= 0 && !localArr[i].isExpire) {
	                        //第一次过期设置
	                        expire++;
	                        localArr[i].isExpire = true;
	                        timeStr = '距结束 00 : 00 : 00';
	                    } else {
	                        var timeObj = formatTime(localArr[i].end - this.state.curTime);
	        ...
	        key: 'renderList',
	        value: function renderList(json) {
	            var _this2 = this;

	            return _react2.default.createElement(
	                'ul',
	                { className: 'commodities_list clearfix' },
	                json.bnList.map(function (res, i) {
	                    return _react2.default.createElement(
	                        'li',
	                        { key: i },
	                        _react2.default.createElement(
	                            'h3',
	                            { className: 'time' },
	                            _this2.renderTime(json.bnList, i)
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'commodities_details' },
	                            _this2.hrefTag(res, i),
	                            _react2.default.createElement(
	                                'a',
	                                { href: res.linkUrl, target: '_blank', className: 'commodities_title', 'data-clstag': 'jr|keycount|newbthome|bainasku' + (i + 1) },
	                                res.title
	                            ),
	                            _react2.default.createElement(
	                                'span',
	                                { className: 'price' },
	                                res.bainaPrice > -1 ? _react2.default.createElement(
	                                    'span',
	                                    null,
	                                    _react2.default.createElement(
	                                        'strong',
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { className: 'buyNow', href: 'javascript:void (0);', 'data-data': res.skuId, 'data-clstag': 'jr|keycount|newbthome|bainabtn' + (i + 1) },
	                                _react2.default.createElement('i', { className: 'mask' }),
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: 'txt' },
	                                    res.newUser ? '立即白拿' : res.remark
	                                )
	                            )
	                        )
	                    );
	        ...
	        key: 'singleRoster',
	        value: function singleRoster(roster, i) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'ul',
	                            { className: 'detail' },
	                            data.roster.map(function (res, i) {
	                                return _this3.singleRoster(data.roster, i);
	                            })
	                        ),
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'lcList', 'data-type': 'lcList' },
	                    data.lcList.map(function (res, i) {
	                        return _react2.default.createElement(
	                            'div',
	                            { key: i, className: 'item' },
	                            _react2.default.createElement(
	                                'a',
	                                { href: res.href, target: '_blank', className: 'pic', 'data-clstag': 'jr|keycount|newbthome|lcbnsku' + (i + 1) },
	                                _react2.default.createElement('img', { className: 'shake', src: res.imgSrc })
	                            ),
	                            _react2.default.createElement(
	                                'a',
	                                { href: res.href, target: '_blank', className: 'title', 'data-clstag': 'jr|keycount|newbthome|lcbnsku' + (i + 1) },
	                                _react2.default.createElement(
	                                    'i',
	                                    null,
	                                    res.tag
	                            ...
	                            _react2.default.createElement(
	                                'a',
	                                { href: res.href, target: '_blank', className: 'buy', 'data-clstag': 'jr|keycount|newbthome|lcbnsku' + (i + 1) },
	                                _react2.default.createElement('i', { className: 'mask' }),
	                                res.buyWord
	                            )
	                        );
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: '//baina.jd.com/', target: '_blank', className: 'more', 'data-clstag': 'jr|keycount|newbthome|lcbnguize' },
	                        _react2.default.createElement(
	                            'i',
	                            { className: 'i1' },
	                            '拿'
	...
	exports.default = (0, _reactRedux.connect)(getData)(ShowList);
...
/***/ function(module, exports) {
	...
	var loopScroll = function loopScroll(options) {
	    var self = this;
	                ...
	                case 'on':
	                    ...
	                    if (data.opened) {
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'sideTitle commodityBn' },
	                                _react2.default.createElement(
	                                    'h3',
	                                    null,
	                                    '白拿'
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'appointment', 'data-type': 'appointment' },
	                                        data.newUser ? _react2.default.createElement(
	                                            'div',
	                                            null,
	                                            _react2.default.createElement(
	                                                'span',
	                                    ...
	                                    _react2.default.createElement(
	                                        'a',
	                                        { className: 'activeRule', href: 'javascript:void (0);', 'data-type': 'bnRule', 'data-clstag': 'jr|keycount|newbthome|bainagz' },
	                                        '详细规则'
	                                    ),
	                                    _react2.default.createElement(
	                                        'a',
	                                        { className: 'activeRule last', href: '//jr.jd.com/buy/index', target: '_blank', 'data-type': 'record', 'data-clstag': 'jr|keycount|newbthome|bainaqdbt' },
	                                        '去打白条'
	                                    )
	                                )
	                            ),
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'span',
	                                        null,
	                                        _react2.default.createElement('i', { className: 'new clearfix' }),
	                                        _react2.default.createElement(
	                                            'em',
	                                            { className: 'm16' },
	                                            '京东全场任意选'
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            'a',
	                                            { href: '//baina.jd.com/', className: 'activeRule clearfix', target: '_blank', 'data-clstag': 'jr|keycount|newbthome|lcbnguize' },
	                                            '详细规则 ',
	                                            _react2.default.createElement(
	                                                'b',
	                                                { className: 'gt' },
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            'a',
	                                            { href: 'javascript:void (0);', className: 'activeRule clearfix', 'data-type': 'bnRule', 'data-clstag': 'jr|keycount|newbthome|bainagz' },
	                                            '白拿规则 ',
	                                            _react2.default.createElement(
	                                                'b',
	                                                { className: 'gt' },
